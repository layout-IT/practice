...
/*alert('могу выбрать любой символ по твоей цифре')
 const first = prompt('введи текст')
 const second = prompt('введи число не более ' + first.length )
...
//if (seconds  <= first.length ){
//	alert("твой символ " + otvet)
//}*/


let vopros = alert('угадаю букву или число  ')
vopros1 = prompt('введите текст или число без пробелов')
vopros2 = prompt('введите цифру от 0 до  ' + vopros1.length)
vopros2 = Number(vopros2)
if (vopros1.length >= vopros2 ){
	vopros3 = vopros1.split('')
	alert('вот ваша буква/цифра : ' + vopros3[(vopros2 - 1)])
}else{
	alert('Вы ввели некорректную цифру. Досвидос!')
}
